...
function Movies(props) {
  ...
  const infoMovie = (e, link, linkLang) => {
    if (e.target.nearestViewportElement.className.animVal.includes("info"))
      window.open(`https://${linkLang}.wikipedia.org/wiki/${link}`);
  };
    ...
    <div id="main-element">
      ...
      <div className="background">
        <div className="movie-container container">
          ...
          <h1 className="title yellow carousel-title">Trend</h1>
          <Carousel
                ...
                return (
                  <div key={movie._id} className="carousel-item">
                    ...
                    <div className="movie-info-container">
                      <p className="yellow preview-info">
                        <span>{movie.name}: </span>
                        {movie.bitDescription !== "-"
                          ? movie.bitDescription
                          : movie.description}
                      </p>
                      <NavLink
                      ...
                      <p
                        ...
                        className="yellow movie-icon"
                        onClick={(e) =>
                          infoMovie(e, movie.wiki, movie.wikiLang)
                        }
                      >
                        {info}
                      </p>
          ...
          <h1 className="title yellow carousel-title">For You</h1>
          <Carousel
            responsive={secondaryResponsive}
            swipeable={false}
            draggable={false}
                  ...
                  <div key={movie._id} className="carousel-item">
                    ...
                    <div className="movie-info-container">
                      ...
                      <p
                        id="info"
                        className="yellow movie-icon"
                        onClick={(e) => infoMovie(e, movie.wiki)}
                      >
                        {info}
                      </p>
                    </div>
